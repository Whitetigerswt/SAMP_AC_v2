...
public:
	...
	virtual bool Send( const char *data, const int length, int priority, int reliability, char orderingChannel );
	virtual bool Send( RakNet::BitStream * bitStream, int priority, int reliability, char orderingChannel );
