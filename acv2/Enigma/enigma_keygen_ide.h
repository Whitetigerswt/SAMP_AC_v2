...
extern "C"
{
  int __declspec(dllimport) __stdcall KG_GenerateRegistrationKey(PKeyGenParams kg);
  int __declspec(dllimport) __stdcall KG_GenerateRegistrationKeyA(PKeyGenParamsA kg);
  int __declspec(dllimport) __stdcall KG_GenerateRegistrationKeyW(PKeyGenParamsW kg);
  int __declspec(dllimport) __stdcall KG_GenerateRegistrationKeyFromProject(char* pfile, PKeyGenParams kg);
  int __declspec(dllimport) __stdcall KG_GenerateRegistrationKeyFromProjectA(char* pfile, PKeyGenParamsA kg);
  int __declspec(dllimport) __stdcall KG_GenerateRegistrationKeyFromProjectW(wchar_t* pfile, PKeyGenParamsW kg);
  int __declspec(dllimport) __stdcall KG_VerifyRegistrationInfo(PKeyVerifyParams kv);
  int __declspec(dllimport) __stdcall KG_VerifyRegistrationInfoA(PKeyVerifyParamsA kv);
  int __declspec(dllimport) __stdcall KG_VerifyRegistrationInfoW(PKeyVerifyParamsW kv);
  int __declspec(dllimport) __stdcall KG_VerifyRegistrationInfoFromProject(char* pfile, PKeyVerifyParams kv);
  int __declspec(dllimport) __stdcall KG_VerifyRegistrationInfoFromProjectA(char* pfile, PKeyVerifyParamsA kv);
  int __declspec(dllimport) __stdcall KG_VerifyRegistrationInfoFromProjectW(wchar_t* pfile, PKeyVerifyParamsW kv);
}
