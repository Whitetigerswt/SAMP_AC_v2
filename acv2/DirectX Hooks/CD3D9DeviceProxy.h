...
class CD3D9DeviceProxy : public IDirect3DDevice9
{
public:
	CD3D9DeviceProxy(IDirect3DDevice9* pDirect3DDevice9, IDirect3D9* pDirect3D9, D3DPRESENT_PARAMETERS *pPresentationParameters);
	~CD3D9DeviceProxy();
